...
const handleViewBookedByMe = () => {
  ...
  try {
    ...
    console.log("Instruments selected in handleViewBookedByMe:", instrumentsBookedByMe);
  } catch (error) {
...
const handleViewAllInstruments = () => {
  ...
  // Add console log to check which instruments are selected
  console.log("Instruments selected in handleViewAllInstruments:", instruments);
};
...
const handleViewBookedByAllUsers = () => {
  ...
  try {
    ...
    console.log("All instruments booked by any user:", instrumentsBooked);
    
    // Add console log to check which instruments are selected
    console.log("Instruments selected in handleViewBookedByAllUsers:", instrumentsBookedByMe);
  } catch (error) {
